...
#
# Based on chapter 23 of Cracking Codes with Python by Al Sweigart
...
def makeKeyFiles(name, keySize):
    ...
    # The safety check will prevent the user from overwriting old key files:
